...
class EmotionalRecycler : RecyclerView.Adapter<EmotionalRecycler.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.asciiText.text = AsciiData.emotional[position]
    }

    override fun getItemCount(): Int {
        return AsciiData.emotional.size
    }
